...
<main>
    <section class="mt-8">
        <div class="container">
            <div class="hero-slider slick-initialized slick-slider slick-dotted">
                <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 3520px; transform: translate3d(-704px, 0px, 0px);"><div style="background: url(&quot;./assets/images/slider/slider-2.jpg&quot;) center center / cover no-repeat; border-radius: 0.5rem; width: 696px;" class="slick-slide slick-cloned" data-slick-index="-1" id="" aria-hidden="true" tabindex="-1">
                        ...
                        </div><div style="background: url(&quot;./assets/images/slider/slide-1.jpg&quot;) center center / cover no-repeat; border-radius: 0.5rem; width: 696px;" class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="0" role="tabpanel" id="slick-slide10" aria-describedby="slick-slide-control10">
                            <div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
                        ...
                        </div><div style="background: url(&quot;./assets/images/slider/slider-2.jpg&quot;) center center / cover no-repeat; border-radius: 0.5rem; width: 696px;" class="slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide11" aria-describedby="slick-slide-control11">
                            <div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
                                <span class="badge text-bg-warning">Free Shipping - orders over $100</span>
                                <h2 class="text-dark display-5 fw-bold mt-4">
                                    Free Shipping on
                        ...
                        </div><div style="background: url(&quot;./assets/images/slider/slide-1.jpg&quot;) center center / cover no-repeat; border-radius: 0.5rem; width: 696px;" class="slick-slide slick-cloned" data-slick-index="2" id="" aria-hidden="true" tabindex="-1">
                            <div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
                                <span class="badge text-bg-warning">Opening Sale Discount 50%</span>
                        ...
                        </div><div style="background: url(&quot;./assets/images/slider/slider-2.jpg&quot;) center center / cover no-repeat; border-radius: 0.5rem; width: 696px;" class="slick-slide slick-cloned" data-slick-index="3" id="" aria-hidden="true" tabindex="-1">
                            <div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
                                <span class="badge text-bg-warning">Free Shipping - orders over $100</span>
                                <h2 class="text-dark display-5 fw-bold mt-4">
                                    Free Shipping on
    ...
    <section class="mb-lg-10 mt-lg-14 my-8">
        <div class="container">
            ...
            <div class="category-slider slick-initialized slick-slider"><span class="slick-prev slick-arrow" style=""><i class="feather-icon icon-chevron-left"></i></span>
                ...
                <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 4224px; transform: translate3d(-1760px, 0px, 0px);"><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="-4" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="-3" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="-2" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="-1" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                        ...
                        </div><div class="item slick-slide" style="width: 160px;" data-slick-index="0" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                        ...
                        </div><div class="item slick-slide" style="width: 160px;" data-slick-index="1" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                        ...
                        </div><div class="item slick-slide" style="width: 160px;" data-slick-index="2" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                        ...
                        </div><div class="item slick-slide" style="width: 160px;" data-slick-index="3" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                        ...
                        </div><div class="item slick-slide" style="width: 160px;" data-slick-index="4" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                        ...
                        </div><div class="item slick-slide" style="width: 160px;" data-slick-index="5" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                        ...
                        </div><div class="item slick-slide slick-active" style="width: 160px;" data-slick-index="6" aria-hidden="false" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="0">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-baby-care.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                                        <div class="text-truncate">Baby Care</div>
                        ...
                        </div><div class="item slick-slide slick-active" style="width: 160px;" data-slick-index="7" aria-hidden="false" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="0">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-chicken-meat-fish.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-current slick-active" style="width: 160px;" data-slick-index="8" aria-hidden="false" tabindex="0">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="0">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-cleaning-essentials.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-active" style="width: 160px;" data-slick-index="9" aria-hidden="false" tabindex="0">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="0">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-pet-care.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="10" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-dairy-bread-eggs.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="11" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-snack-munchies.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="12" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-bakery-biscuits.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="13" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-instant-food.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="14" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-tea-coffee-drinks.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="15" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-atta-rice-dal.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="16" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-baby-care.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="17" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-chicken-meat-fish.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="18" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-cleaning-essentials.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div><div class="item slick-slide slick-cloned" style="width: 160px;" data-slick-index="19" id="" aria-hidden="true" tabindex="-1">
                            <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit" tabindex="-1">
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img src="assets/images/category/category-pet-care.jpg" alt="Grocery Ecommerce Template" class="mb-3">
                        ...
                        </div></div></div><span class="slick-next slick-arrow" style=""><i class="feather-icon icon-chevron-right"></i></span></div>
        </div>
    </section>
                        ...
                        <div class="card card-product">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-start text-center mt-3">
                                    <div class="deals-countdown w-100" data-countdown="2028/10/10 00:00:00"><span class="countdown-section"><span class="countdown-amount hover-up">1541</span><span class="countdown-period"> days </span></span><span class="countdown-section"><span class="countdown-amount hover-up">3</span><span class="countdown-period"> hours </span></span><span class="countdown-section"><span class="countdown-amount hover-up">25</span><span class="countdown-period"> mins </span></span><span class="countdown-section"><span class="countdown-amount hover-up">27</span><span class="countdown-period"> sec </span></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="tns-outer" id="productModal-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">1</span>  of 4</div><div id="productModal-mw" class="tns-ovh"><div class="tns-inner" id="productModal-iw"><div class="product productModal  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" id="productModal" style="transition-duration: 0s; transform: translate3d(0%, 0px, 0px);">
                                        <div class="zoom tns-item tns-slide-active" onmousemove="zoom(event)" style="background-image: url(./assets/images/products/product-single-img-1.jpg)" id="productModal-item0">
                                            <!-- img -->
