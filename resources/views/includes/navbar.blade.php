...
<div class="humberger__menu__wrapper">
    <div class="humberger__menu__logo">
        <a class="text-black-50 font-weight-bold" href="{{route('index')}}">
            ...
            <img style="height: 4rem" src="{{asset('assets/images/setting/' . $setting->logo)}}" alt="">
    ...
    <div class="header__top__right__social">
        @if($setting->facebook_link)
            <a href="{{$setting->facebook_link }}" target="_break"><i class="fa fa-facebook"></i></a>
        @endif
        @if($setting->twitter_link)
            <a href="{{$setting->twitter_link }}" target="_break"><i class="fa fa-twitter"></i></a>
        @endif
        @if($setting->instagram_link)
            <a href="{{$setting->instagram_link }}" target="_break"><i class="fa fa-instagram"></i></a>
        @endif
        @if($setting->youtube_link)
            <a href="{{$setting->youtube_link }}" target="_break"><i class="fa fa-youtube"></i></a>
        @endif
        <!-- @if($setting->instagram_link)
            <a href="{{$setting->instagram_link }}" target="_break"><i class="fa fa-instagram"></i></a>
        @endif -->
